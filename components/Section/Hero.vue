...
<template>
  <section
    ref="sectionRef"
    id="build"
    class="hero bg-white min-h-[100dvh] is-primary is-fullheight relative overflow-hidden"
  >
    ...
    <div class="hero-body relative z-10">
      <div
        ...
        class="lg:p-7 p-4 pt-16 lg:pt-24 max-w-[90rem] flex flex-col justify-between h-[calc(100dvh-7rem)] lg:h-[calc(100dvh-5rem)] transition-opacity duration-700"
      >
